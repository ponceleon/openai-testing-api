...
def index():
    form_html = """
        <form>
            <label for="question">Ingrese su pregunta:</label><br>
            <input type="text" id="question" name="question"><br>
            <button type="button" onclick="sendQuestion()">Enviar pregunta</button>
        </form>
...
# print(answer_question(df, question="De cual ley me estas hablando?", debug=False)) 
